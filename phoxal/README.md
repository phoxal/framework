...
| Module | What it is |
|---|---|
| [`phoxal::api`] | Re-export of the `phoxal-api` crate: the dated API-version modules (`y2026_1`, …) generated by `phoxal_api_tree!` from a tree of nested nodes: the marker `enum Api` (`ApiVersion`), version-local wire bodies + their `ContractBody` impls, and the api-local `topic` builders. |
...
The `phoxal::api` modules (re-exported from the `phoxal-api` crate) are generated by `phoxal_api_tree!` from a tree of **nested nodes**.
