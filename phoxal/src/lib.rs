...
pub mod bus {
    pub use phoxal_bus::{
        ...
        DiagnosticContract, DiagnosticPublisher, Endpoint, EndpointDescriptor, EndpointKind,
...
pub mod prelude {
    ...
    pub use crate::bus::{
        CaptureStamp, CommandPublisher, DiagnosticPublisher, EventPublisher, EventReceiver,
        ExclusiveProducerLease, FixedSourceAdmission, FixedSourceLease, LeaseDecision,
        LocalInstant, MeasurementPublisher, Observed, Querier, QueryError, QueryResult,
