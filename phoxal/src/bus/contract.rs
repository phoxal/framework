...
/// of inferring direction from a [`Publish`](crate::Publish) or
/// [`Subscribe`](crate::Subscribe) topic brand alone.
///
...
/// [`AskQuery`](crate::AskQuery) and [`ServeQuery`](crate::ServeQuery) brands
