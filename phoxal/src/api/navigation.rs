...
const MAX_PATH_POSES: usize = 4096;
...
fn optional_canonical_yaw(value: Option<f64>) -> bool {
...
#[serde(try_from = "PlannedPathWire")]
...
#[derive(Clone, Debug, serde::Deserialize)]
#[serde(deny_unknown_fields)]
struct PlannedPathWire {
    poses: Vec<Pose>,
    map_revision: Option<u64>,
}
impl TryFrom<PlannedPathWire> for PlannedPath {
    type Error = NavigationError;
    fn try_from(value: PlannedPathWire) -> std::result::Result<Self, Self::Error> {
