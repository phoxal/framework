...
use crate::api::map::GridWireError;
...
#[serde(try_from = "crate::api::safety::SafetyConstraintWire")]
pub enum Constraint {
    Limited {
...
#[serde(try_from = "crate::api::safety::SafetyMotionPermissionWire")]
...
#[serde(try_from = "crate::api::safety::SafetyMotionConstraintsWire")]
...
pub enum SafetyMotionPermissionWire {
    ...
    Limited {
        #[serde(
            deserialize_with = "crate::api::safety::deserialize_finite_nonnegative_safety_limit"
        )]
        effective_linear_speed_mps: f32,
        #[serde(
            deserialize_with = "crate::api::safety::deserialize_finite_nonnegative_safety_limit"
        ...
        effective_angular_speed_radps: f32,
        reasons: Vec<crate::api::safety::ConstraintReason>,
    },
    Stopped {
        reasons: Vec<crate::api::safety::ConstraintReason>,
    },
...
pub enum SafetyConstraintWire {
    Limited {
        reason: crate::api::safety::ConstraintReason,
        source: crate::api::safety::ConstraintSource,
        #[serde(
            deserialize_with = "crate::api::safety::deserialize_finite_nonnegative_safety_limit"
        )]
        max_linear_speed_mps: f32,
        ...
        max_angular_speed_radps: f32,
        #[serde(
            deserialize_with = "crate::api::safety::deserialize_optional_finite_safety_value"
        )]
        observed_value: Option<f32>,
        valid_from: ::phoxal::bus::RobotInstant,
        expires_at: ::phoxal::bus::RobotInstant,
...
impl TryFrom<SafetyMotionPermissionWire> for crate::api::safety::MotionPermission {
...
impl TryFrom<SafetyConstraintWire> for crate::api::safety::Constraint {
    type Error = GridWireError;
...
impl TryFrom<SafetyMotionConstraintsWire> for crate::api::safety::MotionConstraints {
    type Error = GridWireError;
    ...
    fn try_from(value: SafetyMotionConstraintsWire) -> Result<Self, Self::Error> {
        ...
        let constraints = value
            ...
            .collect::<Result<Vec<crate::api::safety::Constraint>, GridWireError>>()?;
        ...
        for constraint in &constraints {
            let (valid_from, expires_at) = match constraint {
                crate::api::safety::Constraint::Limited {
                    valid_from,
                    expires_at,
                    ..
                }
                | crate::api::safety::Constraint::Stopped {
                    valid_from,
                    expires_at,
                    ..
...
fn expected_safety_permission(
    constraints: &[crate::api::safety::Constraint],
) -> Result<crate::api::safety::MotionPermission, GridWireError> {
    let reasons = constraints
        .iter()
        .map(|constraint| match constraint {
            crate::api::safety::Constraint::Limited { reason, .. }
            | crate::api::safety::Constraint::Stopped { reason, .. } => reason.clone(),
        })
        .collect::<Vec<_>>();
    if constraints.iter().any(|constraint| {
        ...
        return Ok(crate::api::safety::MotionPermission::Stopped { reasons });
    }
    if constraints.is_empty() {
        return Ok(crate::api::safety::MotionPermission::Clear);
    }
    let mut linear = f32::MAX;
    let mut angular = f32::MAX;
    for constraint in constraints {
        let crate::api::safety::Constraint::Limited {
            max_linear_speed_mps,
            max_angular_speed_radps,
            ..
        } = constraint
    ...
    Ok(crate::api::safety::MotionPermission::Limited {
