...
pub struct Depth {
    ...
    width: Option<u32>,
    height: Option<u32>,
    intrinsics: Option<crate::api::component::capability::camera::v1::Intrinsics>,
    distortion: Option<crate::api::component::capability::camera::v1::Distortion>,
    exposure: Option<crate::api::component::capability::camera::v1::ExposureTiming>,
    measured_at_ns: Option<u64>,
    calibration: Option<crate::api::component::capability::camera::v1::CalibrationIdentity>,
}
