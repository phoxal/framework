...
## [0.19.1](https://github.com/phoxal/framework/releases/tag/phoxal-runtime-presence-v0.19.1) - 2026-06-30
...
- add command/state/query topic roles and reshape presence/video seams ([#117](https://github.com/phoxal/framework/pull/117))
