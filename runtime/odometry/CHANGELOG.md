...
## [0.19.1](https://github.com/phoxal/framework/releases/tag/phoxal-runtime-odometry-v0.19.1) - 2026-06-30
...
- *(runtime)* port `odometry` — differential-drive wheel-odometry estimator (Phase 4) ([#89](https://github.com/phoxal/framework/pull/89))
...
- *(core-robot)* remove redundant KinematicKind discriminator ([#48](https://github.com/phoxal/framework/pull/48))
