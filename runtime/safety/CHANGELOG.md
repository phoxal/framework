...
## [0.19.1](https://github.com/phoxal/framework/releases/tag/phoxal-runtime-safety-v0.19.1) - 2026-06-30
...
- *(runtime)* add `safety` API family + safety-monitor runtime (Phase 4) ([#93](https://github.com/phoxal/framework/pull/93))
