//! The supervisor's internal execution board.
//!
...
//! [`crate::supervisor::projection`] is the one place this
...
pub(crate) struct Board {
    ...
    /// to blame. The supervisor classifies it into a typed
    /// `SupervisorFailure`; this is the evidence it classifies.
