...
const FROZEN_BOOTSTRAP: PinnedTests = PinnedTests {
    ...
    package: CONTRACT_CRATE,
    tests: &[
        "protocol::supervisor::connect::tests::the_bootstrap_key_is_pinned_to_its_literal",
        "protocol::supervisor::connect::tests::the_composed_bootstrap_wire_key_is_pinned_to_its_literal",
        "protocol::supervisor::connect::tests::the_bootstrap_documents_are_pinned_to_their_literal_json",
        "protocol::supervisor::connect::tests::the_bootstrap_documents_are_pinned_to_their_declared_wire_shape",
        "protocol::supervisor::connect::tests::the_bootstrap_documents_round_trip_on_the_bus_codec",
        "protocol::supervisor::connect::tests::a_foreign_schema_tag_fails_by_naming_itself",
    ],
};
