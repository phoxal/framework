...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::domains::v0_2::safety::SafetyConstraintWire")]
pub enum Constraint {
    Limited {
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::domains::v0_2::safety::SafetyMotionPermissionWire")]
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::domains::v0_2::safety::SafetyMotionConstraintsWire")]
...
pub enum SafetyMotionPermissionWire {
    ...
    Limited {
        #[serde(
            deserialize_with = "crate::domains::v0_2::safety::deserialize_finite_nonnegative_safety_limit"
        )]
        effective_linear_speed_mps: f32,
        #[serde(
            deserialize_with = "crate::domains::v0_2::safety::deserialize_finite_nonnegative_safety_limit"
...
pub enum SafetyConstraintWire {
    Limited {
        ...
        max_angular_speed_radps: f32,
        #[serde(
            deserialize_with = "crate::domains::v0_2::safety::deserialize_optional_finite_safety_value"
        )]
        observed_value: Option<f32>,
        valid_from: ::phoxal_bus::RobotInstant,
        expires_at: ::phoxal_bus::RobotInstant,
