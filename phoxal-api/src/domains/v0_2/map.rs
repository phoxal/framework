...
#[serde(try_from = "crate::domains::v0_2::map::GridPointWire")]
pub struct Point {
    pub x_m: f64,
    pub y_m: f64,
}
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::domains::v0_2::map::GridPoseWire")]
pub struct Pose {
    pub x_m: f64,
    pub y_m: f64,
    pub yaw_rad: f64,
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::domains::v0_2::map::GridBoundsWire")]
pub struct Bounds {
    pub min_x_m: f64,
    pub min_y_m: f64,
    pub max_x_m: f64,
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::domains::v0_2::map::GridWindowWire")]
pub struct GridWindow {
    pub frame_id: String,
    pub origin_pose: Pose,
    pub cell_origin: Point,
    #[serde(
        deserialize_with = "crate::domains::v0_2::map::deserialize_finite_positive_resolution"
    )]
    pub resolution_m: f32,
    #[serde(deserialize_with = "crate::domains::v0_2::map::deserialize_nonzero_map_dimension")]
    pub width: u32,
    #[serde(deserialize_with = "crate::domains::v0_2::map::deserialize_nonzero_map_dimension")]
    pub height: u32,
...
pub enum SubmapResponse {
    ...
    OutOfBounds {
        requested: Bounds,
        #[serde(deserialize_with = "crate::domains::v0_2::map::deserialize_nonempty_frame_id")]
        frame_id: String,
        revision: u64,
    },
}
...
pub struct GridBoundsWire {
    #[serde(deserialize_with = "crate::domains::v0_2::map::deserialize_finite_map_scalar")]
    pub min_x_m: f64,
    #[serde(deserialize_with = "crate::domains::v0_2::map::deserialize_finite_map_scalar")]
    pub min_y_m: f64,
    #[serde(deserialize_with = "crate::domains::v0_2::map::deserialize_finite_map_scalar")]
