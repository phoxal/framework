...
pub enum Command {
    Position(
        #[serde(
            deserialize_with = "crate::api::v0_1::component::motor::deserialize_finite_motor_scalar"
        )]
        f32,
    ),
    Velocity(
...
/// Reject non-finite v0.1 motor command scalars during wire deserialization.
