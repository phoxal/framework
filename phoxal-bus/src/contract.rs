...
/// [`phoxal_api!`] generates inside each tree module. The [`ID`] is the
...
///
/// [`ID`]: ApiVersion::ID
/// [`phoxal_api!`]: https://docs.rs/phoxal
...
///
/// Generated by `phoxal_api!` for every ordinary `State<T>` endpoint. Deliberately
