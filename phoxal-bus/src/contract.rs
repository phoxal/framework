...
///   exception: the runtime-owned simulation clock hand is state-temporal but
///   implements the disjoint [`WorldClockContract`] instead of `StateContract`
///   - see that trait's docs for why.
///
/// [`phoxal_api_tree!`]: https://docs.rs/phoxal
