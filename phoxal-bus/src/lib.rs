...
//! live in the `phoxal-api` crate. The `phoxal` engine re-exports this crate at
//! `phoxal::bus` and the API tree at `phoxal::api`, so these traits are also
//! reachable as `phoxal::api::ApiVersion` / `phoxal::api::ContractBody`.
