...
/// a generation module, so a source-text string like `api::drive::Target` has
/// the generation erased and cannot distinguish a `y2026_1` contract from a
/// same-named `y2026_7` one; `GENERATION`/`CONTRACT`
