use crate::api::v0_1::map::GridWireError;

/// Why safety is stopping or limiting body motion in v0.1. The
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::api::v0_1::safety::SafetyConstraintWire")]
pub enum Constraint {
    Limited {
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::api::v0_1::safety::SafetyMotionPermissionWire")]
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::api::v0_1::safety::SafetyMotionConstraintsWire")]
...
pub enum SafetyMotionPermissionWire {
    ...
    Limited {
        #[serde(
            deserialize_with = "crate::api::v0_1::safety::deserialize_finite_nonnegative_safety_limit"
        )]
        effective_linear_speed_mps: f32,
        #[serde(
            deserialize_with = "crate::api::v0_1::safety::deserialize_finite_nonnegative_safety_limit"
        ...
        effective_angular_speed_radps: f32,
        reasons: Vec<crate::api::v0_1::safety::ConstraintReason>,
    },
    Stopped {
        reasons: Vec<crate::api::v0_1::safety::ConstraintReason>,
    },
...
pub enum SafetyConstraintWire {
    Limited {
        reason: crate::api::v0_1::safety::ConstraintReason,
        source: crate::api::v0_1::safety::ConstraintSource,
        #[serde(
            deserialize_with = "crate::api::v0_1::safety::deserialize_finite_nonnegative_safety_limit"
        )]
        max_linear_speed_mps: f32,
        ...
        max_angular_speed_radps: f32,
        #[serde(
            deserialize_with = "crate::api::v0_1::safety::deserialize_optional_finite_safety_value"
        )]
        observed_value: Option<f32>,
        valid_from: ::phoxal_bus::RobotInstant,
        expires_at: ::phoxal_bus::RobotInstant,
...
impl TryFrom<SafetyMotionPermissionWire> for crate::api::v0_1::safety::MotionPermission {
...
impl TryFrom<SafetyConstraintWire> for crate::api::v0_1::safety::Constraint {
    type Error = GridWireError;
...
impl TryFrom<SafetyMotionConstraintsWire> for crate::api::v0_1::safety::MotionConstraints {
    type Error = GridWireError;
    ...
    fn try_from(value: SafetyMotionConstraintsWire) -> Result<Self, Self::Error> {
        ...
        let constraints = value
            ...
            .collect::<Result<Vec<crate::api::v0_1::safety::Constraint>, GridWireError>>()?;
        ...
        for constraint in &constraints {
            let (valid_from, expires_at) = match constraint {
                crate::api::v0_1::safety::Constraint::Limited {
                    valid_from,
                    expires_at,
                    ..
                }
                | crate::api::v0_1::safety::Constraint::Stopped {
                    valid_from,
                    expires_at,
                    ..
...
fn expected_safety_permission(
    constraints: &[crate::api::v0_1::safety::Constraint],
) -> Result<crate::api::v0_1::safety::MotionPermission, GridWireError> {
    let reasons = constraints
        .iter()
        .map(|constraint| match constraint {
            crate::api::v0_1::safety::Constraint::Limited { reason, .. }
            | crate::api::v0_1::safety::Constraint::Stopped { reason, .. } => reason.clone(),
        })
        .collect::<Vec<_>>();
    if constraints.iter().any(|constraint| {
        ...
        return Ok(crate::api::v0_1::safety::MotionPermission::Stopped { reasons });
    }
    if constraints.is_empty() {
        return Ok(crate::api::v0_1::safety::MotionPermission::Clear);
    }
    let mut linear = f32::MAX;
    let mut angular = f32::MAX;
    for constraint in constraints {
        let crate::api::v0_1::safety::Constraint::Limited {
            max_linear_speed_mps,
            max_angular_speed_radps,
            ..
        } = constraint
    ...
    Ok(crate::api::v0_1::safety::MotionPermission::Limited {
