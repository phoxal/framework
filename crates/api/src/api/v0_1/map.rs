...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::api::v0_1::map::GridPointWire")]
pub struct Point {
    pub x_m: f64,
    pub y_m: f64,
}
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::api::v0_1::map::GridPoseWire")]
pub struct Pose {
    pub x_m: f64,
    pub y_m: f64,
    pub yaw_rad: f64,
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::api::v0_1::map::GridBoundsWire")]
pub struct Bounds {
    pub min_x_m: f64,
    pub min_y_m: f64,
    pub max_x_m: f64,
...
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(try_from = "crate::api::v0_1::map::GridWindowWire")]
pub struct GridWindow {
    pub frame_id: String,
    pub origin_pose: Pose,
    pub cell_origin: Point,
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_finite_positive_resolution")]
    pub resolution_m: f32,
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_nonzero_map_dimension")]
    pub width: u32,
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_nonzero_map_dimension")]
    pub height: u32,
...
pub enum SubmapResponse {
    ...
    OutOfBounds {
        requested: Bounds,
        #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_nonempty_frame_id")]
        frame_id: String,
        revision: u64,
    },
}
...
pub struct GridBoundsWire {
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_finite_map_scalar")]
    pub min_x_m: f64,
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_finite_map_scalar")]
    pub min_y_m: f64,
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_finite_map_scalar")]
...
pub struct GridWindowWire {
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_nonempty_frame_id")]
    pub frame_id: String,
    pub origin_pose: crate::api::v0_1::map::Pose,
    pub cell_origin: crate::api::v0_1::map::Point,
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_finite_positive_resolution")]
    pub resolution_m: f32,
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_nonzero_map_dimension")]
    pub width: u32,
    #[serde(deserialize_with = "crate::api::v0_1::map::deserialize_nonzero_map_dimension")]
    pub height: u32,
    pub cells: Vec<crate::api::v0_1::map::Occupancy>,
    pub revision: u64,
    pub requested: crate::api::v0_1::map::Bounds,
    pub covered: crate::api::v0_1::map::Bounds,
}
...
impl TryFrom<GridBoundsWire> for crate::api::v0_1::map::Bounds {
...
impl TryFrom<GridPoseWire> for crate::api::v0_1::map::Pose {
    type Error = GridWireError;
...
impl TryFrom<GridPointWire> for crate::api::v0_1::map::Point {
    type Error = GridWireError;
...
impl TryFrom<GridWindowWire> for crate::api::v0_1::map::GridWindow {
    type Error = GridWireError;
