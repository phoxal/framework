...
//! in family-first modules. A sibling [`protocol_fragment!`] declares only
...
//! [`protocol_tree!`] materializes deterministic descriptors and typed topic
...
pub use phoxal_macros::{protocol_fragment, protocol_fragment_group, protocol_tree};
