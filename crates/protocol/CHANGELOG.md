...
Releases below the first `phoxal-protocol` entry preserve the immutable
`phoxal-api` package and tag names they were published under.
...
## [0.58.2](https://github.com/phoxal/framework/compare/phoxal-api-v0.58.1...phoxal-api-v0.58.2) - 2026-08-10

### Added

- make the compatibility promise checkable against published trains ([#437](https://github.com/phoxal/framework/pull/437))

## [0.57.0](https://github.com/phoxal/framework/compare/phoxal-api-v0.56.2...phoxal-api-v0.57.0) - 2026-08-10
