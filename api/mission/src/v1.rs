...
phoxal_infra_bus::pubsub_leaf!(command, COMMAND_TOPIC, MissionCommand);
phoxal_infra_bus::pubsub_leaf!(state, STATE_TOPIC, State);
phoxal_infra_bus::pubsub_leaf!(goal, GOAL_TOPIC, Goal);

pub mod debug {
    use super::*;

    phoxal_infra_bus::pubsub_leaf!(decision_trace, DEBUG_DECISION_TRACE_TOPIC, DecisionTrace);
}
