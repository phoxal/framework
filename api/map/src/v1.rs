...
phoxal_infra_bus::request_schema!(SubmapRequest, "runtime/map/query/submap/request");
phoxal_infra_bus::request_schema!(EsdfTileRequest, "runtime/map/query/esdf_tile/request");
phoxal_infra_bus::request_schema!(
    TraversabilityTileRequest,
    "runtime/map/query/traversability_tile/request"
);
phoxal_infra_bus::request_schema!(LocalGridRequest, "runtime/map/query/local_grid/request");
phoxal_infra_bus::request_schema!(GlobalGridRequest, "runtime/map/query/global_grid/request");
phoxal_infra_bus::request_schema!(SnapshotRequest, "runtime/map/query/snapshot/request");
...
phoxal_infra_bus::pubsub_leaf!(revision, REVISION_TOPIC, MapRevision);
phoxal_infra_bus::pubsub_leaf!(summary, SUMMARY_TOPIC, Summary);
phoxal_infra_bus::pubsub_leaf!(local_cost, LOCAL_COST_TOPIC, LocalCost);
phoxal_infra_bus::pubsub_leaf!(traversability, TRAVERSABILITY_TOPIC, Traversability);
...
pub mod query {
    ...
    phoxal_infra_bus::query_leaf!(submap, QUERY_SUBMAP_TOPIC, SubmapRequest, SubmapResponse);
