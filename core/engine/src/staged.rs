...
use phoxal_core_component::v1::capability::{Capability, Encoder, Motor, StructuralTarget};
use phoxal_core_robot::v1::Robot as RobotManifest;
use phoxal_core_robot::v1::capability::Parameters;
use phoxal_core_robot::v1::{self as model_v1, ResolvedFacts, SourceBundle, resolve_source_bundle};
use phoxal_core_structure::Structure;

#[derive(Debug, Clone)]
pub struct Robot {
    pub model: RobotManifest,
    pub components: BTreeMap<String, phoxal_core_component::v1::Component>,
}
...
pub struct DriverBinding<'a> {
    ...
    pub component: &'a phoxal_core_component::v1::Component,
...
impl Robot {
    ...
    fn read_model_config(path: impl AsRef<Path>) -> Result<RobotManifest> {
        phoxal_core_robot::v1::Robot::read_from_dir(path)
    }
    ...
    fn read_used_component_configs(
        path: impl AsRef<Path>,
        model: &RobotManifest,
    ) -> Result<BTreeMap<String, phoxal_core_component::v1::Component>> {
        model
    ...
    ) -> Option<&phoxal_core_robot::v1::capability::Parameters> {
...
mod tests {
    ...
    use phoxal_core_component::v1::Component as ComponentSpec;
    use phoxal_core_component::v1::capability::{Camera, CameraMode, Depth};
